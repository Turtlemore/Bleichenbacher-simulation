...
var k = 1024						//Key size in bits, can be changed to values such 512, 1024 and 2048
...
var useBlinding = true  			//Boolean to enable(true) and diable(false) the blinding-step
